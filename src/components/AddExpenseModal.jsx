            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-3xl shadow-2xl p-8 animate-in slide-in-from-bottom duration-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 font-medium">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input required type="number" placeholder="0.00"
                                className="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 bg-slate-50 dark:bg-slate-800 dark:text-white mt-2 outline-none focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input required type="date"
                                className="w-full border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 bg-slate-50 dark:bg-slate-800 dark:text-white text-sm mt-2 outline-none focus:border-blue-500"
                    ...
                    <button disabled={loading}
                        className="w-full bg-slate-900 dark:bg-black text-white py-4 rounded-2xl font-black shadow-xl active:scale-95 transition-all mt-4 tracking-widest uppercase text-xs flex items-center justify-center gap-2">
