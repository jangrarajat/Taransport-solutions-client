          ...
          <div className="bg-white dark:bg-slate-900 w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded shadow-2xl animate-in zoom-in duration-300 my-auto">
            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-4 pt-6 border-t dark:border-slate-700 font-bold">
                ...
                <button type="submit" onClick={handleAddPayment} className="bg-blue-600 w-10 hover:bg-blue-700 text-white px-10  rounded font-black shadow-lg shadow-blue-200 dark:shadow-blue-900/50 transition-all active:scale-95 disabled:opacity-50 duration-200 order-1 sm:order-2 uppercase text-xs tracking-widest flex items-center justify-center">
