...
function Bilty({ pData }) {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            <div className="invoice-box text-xs" style={{ transform: 'scale(0.9)', transformOrigin: 'center' }}>
                    ...
                    <tbody>
                        <tr>
                            <td rowSpan="3" style={{ width: '20%', textAlign: 'center' }}>
                                ...
                                <div className="email-text">Email: <br /> sawariyalogistic@gmail.com</div>
                            </td>
                            <td colSpan="4">
                                ...
                                <div className="address-text">
                                    ...
                                    Head Office : 188, Mehrana, Charkhi Dadri, Haryana 127306
                                </div>
                            </td>
