...
const AddOtherPersonTransactionModal = ({ isOpen, onClose, onSubmit, showNotification }) => {
      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-md shadow-2xl animate-in zoom-in duration-300 my-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="space-y-1">
            ...
            <input
              type="text"
              placeholder="e.g., Loan for house, return of previous loan..."
              value={description}
...
export default AddOtherPersonTransactionModal;